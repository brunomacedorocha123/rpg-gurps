...
// ===== 3. FUNÇÕES DE BUSCA DE PERÍCIAS =====
function buscarPericiaParaTecnica(nomePericia) {
    ...
    if (window.estadoPericias && window.estadoPericias.periciasAprendidas) {
        ...
        if (nomePericia === "Arco") {
            ...
            // Se não encontrou "Arco" exato, busca qualquer que tenha "arco"
            for (let pericia of pericias) {
                if (!pericia || !pericia.nome) continue;
                if (pericia.nome.toLowerCase().includes("arco")) {
                    return {
                        tem: true,
                        nivel: pericia.nivel || pericia.valor || 0,
                        nome: pericia.nome
        ...
        // PARA CAVALGAR: busca QUALQUER especialização
    ...
    try {
        ...
        console.error("Erro ao buscar perícias:", e);
    }
    
    // 3. Retorna não encontrado
    return { 
        tem: false, 
        nivel: 0, 
...
// ===== 7. RENDERIZAR TÉCNICAS APRENDIDAS (SIMPLES) =====
            ...
            <div class="modal-corpo">
                ...
                <div class="modal-alerta">
                    ...
                    <div>
                        ...
                        <p>Você precisa aprender Arco e Cavalgar (qualquer) para adquirir esta técnica.</p>
                    </div>
                </div>
                `}
            </div>

...
function inicializarAtributos() {
    ...
    if (!carregarLocal()) {
        ...
        // Para começar com IQ 11 como na imagem, troque a linha abaixo:
        document.getElementById('IQ').value = 10; // Troque para 11 se quiser
        personagemAtributos.IQ = 10; // Troque para 11 se quiser
    }

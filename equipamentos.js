// equipamentos.js - SISTEMA COMPLETO COM DINHEIRO POR RIQUEZA - VERSÃO COM INTEGRAÇÃO 100%
...
// ✅ INTEGRAÇÃO COM RIQUEZA: Dinheiro inicial baseado no nível de riqueza do jogador
...
class SistemaEquipamentos {
    constructor() {
        ...
        // NOVAS PROPRIEDADES PARA INTEGRAÇÃO COM RIQUEZA
        this.nivelRiquezaAtual = null;
        this.valorBaseRiqueza = 1000; // Valor base para "Médio" (0 pontos)
    ...
    // NOVO MÉTODO: Aguardar sistema de riqueza estar disponível
    ...
    // NOVO MÉTODO: Obter pontos de riqueza atual
    obterPontosRiquezaAtual() {
        if (window.sistemaRiqueza && typeof window.sistemaRiqueza.getPontosRiqueza === 'function') {
            return window.sistemaRiqueza.getPontosRiqueza();
        }
        // Fallback: ler diretamente do select
    ...
    // NOVO MÉTODO: Mapear pontos para multiplicador
    ...
    // NOVO MÉTODO: Calcular dinheiro baseado na riqueza
    ...
    // NOVO MÉTODO: Inicializar dinheiro com base na riqueza
    ...
    // NOVO MÉTODO: Configurar observador para mudanças de riqueza
    configurarObservadorRiqueza() {
        // Escutar eventos do sistema de riqueza
        document.addEventListener('caracteristicasAtualizadas', (e) => {
            if (e.detail && e.detail.tipo === 'riqueza' && e.detail.pontos !== undefined) {
                this.atualizarDinheiroPorMudancaRiqueza(e.detail.pontos);
            }
        });
        
        // Também escutar mudanças diretas no select (fallback)
        const selectRiqueza = document.getElementById('nivelRiqueza');
        if (selectRiqueza) {
    ...
    // NOVO MÉTODO: Atualizar dinheiro quando riqueza mudar
    ...
    // NOVO MÉTODO: Obter nome do nível de riqueza
    ...
    // ... [TODO O RESTO DO CÓDIGO EXISTENTE PERMANECE IGUAL] ...
    // ... [todos os métodos existentes continuam exatamente como estão] ...
    ...
    gerarBotoesControle(equipamento) {
        ...
        if (equipamento.status === 'deposito') {
            ...
            botoes += `<button class="btn-equipamento-acao" onclick="sistemaEquipamentos.desequiparItem('${equipamento.idUnico}')"><i class="fas fa-box"></i> Guardar</button>
                       <button class="btn-equipamento-acao" onclick="sistemaEquipamentos.moverParaDeposito('${equipamento.idUnico}')"><i class="fas fa-home"></i> Depósito</button>`;
        } else {
        ...
        listaDeposito.innerHTML = this.deposito.map(equipamento => `
            <div class="item-deposito">
                ...
                <div class="controles-item-deposito">
                    ...
                    <button class="btn-deposito" title="Excluir permanentemente" style="background: rgba(100,100,100,0.2); border-color: #666; color: #ccc;" onclick="sistemaEquipamentos.excluirItem('${equipamento.idUnico}')">
        ...
        preview.innerHTML = `
            <div class="preview-item">
                ...
                <div class="preview-info">
                    ...
                    ${magico ? `
                        <div class="preview-magico">
                            <strong>✨ Efeito Mágico:</strong>
                            <p>${document.getElementById('item-efeito-magico')?.value || 'Efeito não especificado'}</p>
                        </div>
                    ` : ''}
                </div>
            </div>
